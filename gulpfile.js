...
gulp.task('default', function (callback) {
	runSequence(
		'clean:build',
		['styles', 'pug', 'copy:libs', 'copy:libs-local', 'copy:img', 'copy:js', 'copy:build:files'],
		'server',
		callback
	)
	...
	gulp.watch('src/libs/**/*.*', gulp.parallel('copy:libs-local'));
...
gulp.task('docs', function (callback) {
	runSequence(
		'clean:build',
		['styles', 'pug', 'copy:libs', 'copy:libs-local', 'copy:img', 'copy:js'],
		'clean:docs',
